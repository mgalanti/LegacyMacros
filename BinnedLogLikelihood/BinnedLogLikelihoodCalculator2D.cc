#ifndef BinnedLogLikelihoodCalculator2D_cc
#define BinnedLogLikelihoodCalculator2D_cc
...
#include "BinnedLogLikelihood2D.h"
...
void BinnedLogLikelihoodCalculator2D(const std::string inputFileNameData, const std::string inputFileNameMC, const std::string templateNamesMerged, std::string sRemoveBin)
{
  ...
  BinnedLogLikelihood2D* likelihood = new BinnedLogLikelihood2D(templates, hData, removeBin);
...
#endif // BinnedLogLikelihoodCalculator2D_cc
