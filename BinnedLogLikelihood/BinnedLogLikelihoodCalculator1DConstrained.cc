#ifndef BinnedLogLikelihoodCalculator1DConstrained_cc
#define BinnedLogLikelihoodCalculator1DConstrained_cc
...
#include "BinnedLogLikelihood1DConstrained.h"
...
void BinnedLogLikelihoodCalculator1DConstrained(const std::string inputFileNameData, const std::string inputFileNameMC, const std::string templateNamesMerged, std::string sConstraintComponentMerged, std::string sConstraintValueMerged, std::string sConstraintErrorMerged /*std::map<unsigned int, std::pair<double, double> > mConstraints*/)
{
  ...
  BinnedLogLikelihood1DConstrained* likelihood = new BinnedLogLikelihood1DConstrained(templates, hData, vConstraintComponent, vConstraintValue, vConstraintError);
...
vvoid TokenizeString(const std::string& str, std::vector<std::string>& tokens, const std::string& delimiters)
{
...
#endif // BinnedLogLikelihoodCalculator1DConstrained_cc
