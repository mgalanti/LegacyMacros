#ifndef BinnedLogLikelihoodCalculator2DConstrainedSum_cc
#define BinnedLogLikelihoodCalculator2DConstrainedSum_cc
...
#include "BinnedLogLikelihood2DConstrainedSum.h"
...
void BinnedLogLikelihoodCalculator2DConstrainedSum(const std::string inputFileNameData, const std::string inputFileNameMC, const std::string templateNamesMerged, std::string sConstraintComponentMerged, std::string sConstraintValueMerged, std::string sConstraintErrorMerged, std::string sRemoveBin)
{
  ...
  BinnedLogLikelihood2DConstrainedSum* likelihood = new BinnedLogLikelihood2DConstrainedSum(templates, hData, vConstraintComponent, vConstraintValue, vConstraintError, removeBin);
...
#endif // BinnedLogLikelihoodCalculator2DConstrainedSum_cc
