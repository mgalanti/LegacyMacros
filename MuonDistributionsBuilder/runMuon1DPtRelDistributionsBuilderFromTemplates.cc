...
void runMuon1DPtRelDistributionsBuilderFromTemplates(std::string inputFileName, std::string outputFileName, std::string inputHistoNames1DMerged, std::string nEventsPerTemplateStringMerged, const double fitMin=0., const double fitMax=0.2)
{
