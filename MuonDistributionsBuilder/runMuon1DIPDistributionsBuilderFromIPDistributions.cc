void runMuon1DIPDistributionsBuilderFromIPDistributions(std::string inputFileName, std::string outputFileName, std::string inputHistoName1D, const double fitMin=0., const double fitMax=0.2,const int rebinFactor=5)
{
