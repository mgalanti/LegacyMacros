...
void runMuon2DPtRelDistributionsBuilderFromTemplates(std::string inputFileName, std::string outputFileName, std::string inputHistoNames2DMerged, std::string nEventsPerTemplateStringMerged, const double fitMin=0., const double fitMax=0.2)
{
  ...
  TokenizeString(inputHistoNames2DMerged,inputHistoNames2D);
