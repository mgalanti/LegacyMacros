void runMuon2DIPDistributionsBuilderFromIPDistributions(std::string inputFileName, std::string outputFileName, std::string inputHistoName2D, const double fitMin=0., const double fitMax=0.2,const int rebinFactor=5, const int removeBin=0)
{
