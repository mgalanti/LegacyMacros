...
void runMuonTemplatesBuilder(std::string inputFileName, std::string outputFileName, std::string inputHistoNamesMerged, std::string outputHistoNamesMerged, double fitMin=0., double fitMax=0.2,int rebinFactor, int removeBin, std::string inputFileNamePrompt="", std::string inputHistoNamePrompt="")
{
