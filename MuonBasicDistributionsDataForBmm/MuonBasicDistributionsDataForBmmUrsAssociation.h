#ifndef MuonBasicDistributionsDataForBmmUrsAssociation_h
#define MuonBasicDistributionsDataForBmmUrsAssociation_h
...
class MuonBasicDistributionsDataForBmmUrsAssociation : public TreeAnalyzerMC , public EfficiencyFactorsGetter
{
  public:
    MuonBasicDistributionsDataForBmmUrsAssociation(const std::string sampleName_, const std::string text_, const int maxEvents_ = -1, TTree* tree=0) : TreeAnalyzerMC("MuonBasicDistributionsDataForBmmUrsAssociation", sampleName_, text_, maxEvents_, tree) {};
    virtual void Loop();
...
#endif // MuonBasicDistributionsDataForBmmUrsAssociation_h
