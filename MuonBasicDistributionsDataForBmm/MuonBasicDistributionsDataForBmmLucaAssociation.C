#ifndef MuonBasicDistributionsDataForBmmLucaAssociation_cxx
#define MuonBasicDistributionsDataForBmmLucaAssociation_cxx
...
#include "MuonBasicDistributionsDataForBmmLucaAssociation.h"
#include "../utilities/constants.h"



void MuonBasicDistributionsDataForBmmLucaAssociation::Loop()
{
  if (fChain == 0) return;
...
//             if(iTrackWithDistance.second < 0.1 && dPtOverPt < 0.05)
            if(iGenParticleWithDistance.second < 0.1)
            {
...
std::string MuonBasicDistributionsDataForBmmLucaAssociation::GetBinningVariableString(const std::string sBinning)
{
...
std::vector<double> MuonBasicDistributionsDataForBmmLucaAssociation::GetBins(const std::string sBinning)
{
...
std::vector<double> MuonBasicDistributionsDataForBmmLucaAssociation::ParseBins(const std::string sBins)
{
...
std::vector<double> MuonBasicDistributionsDataForBmmLucaAssociation::GetBinningVariablesValues(const unsigned int iMuon)
{
...
std::vector<double> MuonBasicDistributionsDataForBmmLucaAssociation::GetGenBinningVariablesValues(const unsigned int iGenParticle)
{
  std::vector<double> result;
  result.push_back(1e100);
...
#endif // MuonBasicDistributionsDataForBmmLucaAssociation_cxx
