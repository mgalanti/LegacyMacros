#ifndef MuonBasicDistributionsDataForBmm_h
#define MuonBasicDistributionsDataForBmm_h
...
class MuonBasicDistributionsDataForBmm : public TreeAnalyzerMC , public EfficiencyFactorsGetter
{
  public:
    MuonBasicDistributionsDataForBmm(const std::string sampleName_, const std::string text_, const int maxEvents_ = -1, TTree* tree=0) : TreeAnalyzerMC("MuonBasicDistributionsDataForBmm", sampleName_, text_, maxEvents_, tree) {};
    virtual void Loop();
...
#endif // MuonBasicDistributionsDataForBmm_h
