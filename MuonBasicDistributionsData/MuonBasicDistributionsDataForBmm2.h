#ifndef MuonBasicDistributionsDataForBmm2_h
#define MuonBasicDistributionsDataForBmm2_h
...
class MuonBasicDistributionsDataForBmm2 : public TreeAnalyzerMC , public EfficiencyFactorsGetter
{
  public:
    MuonBasicDistributionsDataForBmm2(const std::string sampleName_, const std::string text_, const int maxEvents_ = -1, TTree* tree=0) : TreeAnalyzerMC("MuonBasicDistributionsDataForBmm2", sampleName_, text_, maxEvents_, tree) {};
    virtual void Loop();
...
#endif // MuonBasicDistributionsDataForBmm2_h
